...
public class BillShotgun : MonoBehaviour
{
    ...
    public void Damage_Handler()
    {
        ...
        if (Bill_Shotgun_Collider.IsTouching(Melee_Weapon) && Is_Invincible == false && Weapon_Live == true)
        {
        ...
        if (Is_Dead)
        {
            ...
            Bill_Shotgun_Collider.enabled = false;
    ...
    private IEnumerator Respawn()
    {
        ...
        Bill_Shotgun_Collider.enabled = true;
